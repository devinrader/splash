CREATE TABLE IF NOT EXISTS pool_settings (
  ...
  weather_location_latitude REAL,
  weather_location_longitude REAL,
  weather_location_timezone TEXT,
  weather_geocoded_latitude REAL,
  weather_geocoded_longitude REAL,
  weather_geocode_provider TEXT,
  weather_geocoded_at TEXT,
  weather_config TEXT NOT NULL DEFAULT '{}',
